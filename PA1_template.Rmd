...
It seems that there are `r total_NA` intervals with missing steps. The presence of this missing data may introduce bias into some calculations or summaries of the data.
